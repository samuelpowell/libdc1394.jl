...
function Camera(guid::Integer)
  handle=ccall((:dc1394_camera_new,libdc1394),
...
function Camera(id::dc1394camera_id_t)
  handle=ccall((:dc1394_camera_new_unit,libdc1394),
    Ptr{dc1394camera_info_t},
    (Ptr{dc1394_t},UInt64,Cint),
    dc1394,id.guid,Cint(id.unit))
  camera=Camera(handle)
  finalizer(camera,camera_free);
  camera
end
...
function camera_free(camera::Camera)
  ...
  if camera.handle!=C_NULL
    ccall((:dc1394_camera_free,libdc1394),
      Void,
      (Ptr{dc1394camera_info_t},),
      camera.handle)
  end
...
function is_same_camera(id1::dc1394camera_id_t,id2::dc1394camera_id_t)
  val=ccall((:dc1394_is_same_camera,libdc1394),
    dc1394bool_t,
    (dc1394camera_id_t,dc1394camera_id_t),
    id1,id2)
  val==TRUE
end
