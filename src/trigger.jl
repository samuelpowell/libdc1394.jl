...
function external_trigger_set_polarity(camera::Camera,polarity::dc1394trigger_polarity_t)
    ccall((:dc1394_external_trigger_set_polarity,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},dc1394trigger_polarity_t),camera.handle,polarity)
end

function external_trigger_get_polarity(camera::Camera)
    polarity=Array{dc1394trigger_polarity_t,1}(1)
    ccall((:dc1394_external_trigger_get_polarity,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394trigger_polarity_t}),camera.handle,polarity)
    polarity[1]
end

function external_trigger_has_polarity(camera::Camera)
    polarity_capable=[dc1394bool_t(FALSE)]
    ccall((:dc1394_external_trigger_has_polarity,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394bool_t}),camera.handle,polarity_capable)
    polarity_capable[1]==TRUE
end

function external_trigger_set_power(camera::Camera,pwr::dc1394switch_t)
    ccall((:dc1394_external_trigger_set_power,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},dc1394switch_t),camera.handle,pwr)
end

function external_trigger_get_power(camera::Camera)
    pwr=[dc1394switch_t(OFF)]
    ccall((:dc1394_external_trigger_get_power,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394switch_t}),camera.handle,pwr)
    pwr[1]
end

function external_trigger_set_mode(camera::Camera,mode::dc1394trigger_mode_t)
    ccall((:dc1394_external_trigger_set_mode,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},dc1394trigger_mode_t),camera.handle,mode)
end

function external_trigger_get_mode(camera::Camera)
    mode=Array{dc1394trigger_mode_t,1}(1)
    ccall((:dc1394_external_trigger_get_mode,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394trigger_mode_t}),camera.handle,mode)
    mode[1]
end

function external_trigger_set_source(camera::Camera,source::dc1394trigger_source_t)
    ccall((:dc1394_external_trigger_set_source,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},dc1394trigger_source_t),camera.handle,source)
end

function external_trigger_get_source(camera::Camera)
    source=Array{dc1394trigger_source_t,1}(1)
    ccall((:dc1394_external_trigger_get_source,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394trigger_source_t}),camera.handle,source)
    source[1]
end

function external_trigger_get_supported_sources(camera::Camera)
    sources=Array{dc1394trigger_sources_t,1}(1)
    ccall((:dc1394_external_trigger_get_supported_sources,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394trigger_sources_t}),camera.handle,sources)
    sources[1].sources[1:sources[1].num]
end

function software_trigger_set_power(camera::Camera,pwr::dc1394switch_t)
    ccall((:dc1394_software_trigger_set_power,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},dc1394switch_t),camera.handle,pwr)
end

function software_trigger_get_power(camera::Camera)
    pwr=[dc1394switch_t(OFF)]
    ccall((:dc1394_software_trigger_get_power,libdc1394),dc1394error_t,(Ptr{dc1394camera_info_t},Ptr{dc1394switch_t}),camera.handle,pwr)
    pwr[1]
end
